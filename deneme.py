...
if __name__ == '__main__':
    ...
    taylor_stats1 = sm.taylor_statistics(filep["kayma-tahmin"], filep["Fs(kay) gercek"], 'data')
    taylor_stats2 = sm.taylor_statistics(filer["kayma-tahmin"], filer["Fs(kay) gercek"], 'data')
    taylor_stats3 = sm.taylor_statistics(filek["kayma-tahmin"], filek["Fs(kay) gercek"], 'data')
    ...
    sm.taylor_diagram(sdev,crmsd,ccoef, markerLabel = label, markerLabelColor = 'r',
                      ...
                      titleRMS = 'on', titleOBS = 'Ref', checkstats = 'on',axismax=2)
